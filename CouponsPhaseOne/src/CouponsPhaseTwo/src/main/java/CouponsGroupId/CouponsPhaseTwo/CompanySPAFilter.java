...
@Path("companyspafilter")
public class CompanySPAFilter implements Filter {

	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
			throws IOException, ServletException {
		// Log.info("AdminSPAfFilter -> doFilter");

		if (((HttpServletRequest) request).getSession(false).getAttribute("Facade") instanceof CompanyFacade) {
